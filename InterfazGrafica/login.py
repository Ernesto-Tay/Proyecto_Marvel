...
class MundoComicLogin(QWidget):
    def __init__(self, auth, on_login_exitoso):
        ...
        self.setWindowTitle("Mundo Comic - Catalogo Virtual")
    ...
    def setup_ui(self):
        ...
        sub_titulo = QLabel("- Catalogo Virtual -")
        ...
        self.pass_input.setPlaceholderText("CONTRASENA")
        ...
        links = QLabel("Olvido su contrasena?")
    ...
    def intentar_login(self):
        ...
        if exito:
            QMessageBox.information(self, "Confirmacion", f"Bienvenido {self.auth.admin.nombre}")
...
if __name__ == "__main__":
    ...
    def ir_al_menu():
        try:
            ...
            # CORRECCION: mostrar el error de construccion del menu principal en pantalla, no solo en consola.
            QMessageBox.critical(login_win, "Error al cargar el menu principal", str(e))
            print(f"Error al cargar el menu principal: {e}")
